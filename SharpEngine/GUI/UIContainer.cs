...
namespace SharpEngine.GUI
{
    public class UIContainer : UIElement
    {
        ...
        #region Constructor
        public UIContainer()
            : this(new Point(0, 0), UI.UIWindow.Size, "Container" + UI.GetUniqueElementID())
        {
        ...
        public void AddElement(UIElement Element)
        {
            if (Element.Name == null || Element.Name.Length == 0)
            {
                ...
                Element.Name = Element.ToString() + UI.GetUniqueElementID();
                //Logger.Instance.WriteLine(LogFlags.UI, "Assigned the name \"" + Element.Name + "\" to the Element.");
            }
            if (UI.Elements.ContainsKey(Element.Name))
            {
            ...
            UI.Elements.Add(Element.Name, Element);
            Element.Parent = this;
            elements.Add(Element);

            if (this == UI.UIWindow) Element.OnResize();
        }

        public void RemoveElement(UIElement Element)
        {
            if (Element.Name != null && UI.Elements.ContainsKey(Element.Name)) UI.Elements.Remove(Element.Name);
        ...
        public override void OnResize()
        {
            ...
            if (this != UI.UIWindow && this.Parent == null) return;
