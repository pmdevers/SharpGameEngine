        ...
        public virtual void OnResize()
        {
            if (Parent == null)
            {
                if (RelativeTo == Corner.BottomLeft) CorrectedPosition = Position;
                    ...
                    CorrectedPosition = new Point(UI.Width - Position.X - Size.X, Position.Y);
                else if (RelativeTo == Corner.TopRight)
                    CorrectedPosition = new Point(UI.Width - Position.X - Size.X, -Position.Y - Size.Y);
                else if (RelativeTo == Corner.Bottom)
                    CorrectedPosition = new Point(UI.Width / 2 - Size.X / 2 + Position.X, Position.Y);
                else if (RelativeTo == Corner.Top)
                    CorrectedPosition = new Point(UI.Width / 2 - Size.X / 2 + Position.X, -Position.Y - Size.Y);
                else if (RelativeTo == Corner.Center)
                    CorrectedPosition = new Point(UI.Width / 2 - Size.X / 2 + Position.X, UI.Height / 2 - Size.Y / 2 + Position.Y);
            }
            else
            {
                if (RelativeTo == Corner.BottomLeft) CorrectedPosition = Position;
