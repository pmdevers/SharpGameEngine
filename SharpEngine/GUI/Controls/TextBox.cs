...
namespace SharpEngine.GUI.Controls
{
    public class TextBox : UIElement
    {
        ...
        public TextBox(BMFont font, Texture scrollTexture, int selectedLine = -1)
        {
            ...
            //        int y = (CorrectedPosition.Y + Size.Y) - (UI.Height - eventArgs.Location.Y);
        ...
        private void BuildVAOs()
        {
            ...
            {
                if (scrollBar.Name == null || !UI.Elements.ContainsKey(scrollBar.Name)) 
        ...
        {
            if (System.Threading.Thread.CurrentThread.ManagedThreadId != UI.MainThreadID)
