...
namespace SharpEngine.GUI.Controls
{
    public class ColorGradient : UIElement
    {
        ...
        private void UpdateMousePosition(int x, int y)
        {
            ...
            sely = Math.Min(1, (float)((UI.Height - y) - CorrectedPosition.Y) / Size.Y);
    ...
    public class HueGradient : UIElement
    {
        ...
        private void UpdateMousePosition(int x, int y)
        {
            ...
            float hue = ((UI.Height - y) - CorrectedPosition.Y) / (float)Size.Y;
            Program.Use();
            Program["hue"].SetValue((float)((UI.Height - y) - CorrectedPosition.Y));
